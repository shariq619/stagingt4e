...
@section('breadcump')
<div class="col-sm-6">
    <h1 class="m-0">{{ __('Change Category') }}</h1>
</div>
<div class="col-sm-6">
...
{{--            </div>--}}
            <div class="card-body">
                ...
                <form action="{{ route('backend.categories.update', $category) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteRoleLabel">{{ __('delete category') }}</h5>
