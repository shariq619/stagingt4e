            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-tools userDashboard d-flex align-items-center justify-content-between">
                        <form action="{{ route('backend.categories.index') }}" method="GET" class="d-flex  align-items-center formUser">
                            ...
                            <tbody>
                                @forelse ($categories as $category)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($category->image)
                                                <img src="{{ asset($category->image) }}" alt="{{ $category->name }}" class="img-thumbnail" style="max-width: 100px;">
                                            @endif
                                        </td>
                                        <td>
                                            ...
                                            @else
                                                @can('change category')
                                                    <a href="{{ route('backend.categories.edit', $category->slug) }}"
