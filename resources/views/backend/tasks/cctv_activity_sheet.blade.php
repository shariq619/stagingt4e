            ...
            <form action="{{ route('backend.task.submission') }}" method="POST" id="submitForm" enctype="multipart/form-data">
                ...
                <div class="col-12">
                    ...
                    <div class="studyAssessment">
                        <h3 class="floatingpdftitle">CCTV Activity Sheet</h3>
                        <div
                            ...
                            <div href="{{ asset('resources/DistanceLearningBooklet_CCTV_2023_V11.pdf') }}"
                                class="popup-pdf"><i class="fas fa-file-pdf"></i></div>
                        </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="course_start_date" name="data[course_start_date]"
                                        class="form-control"
                                        value="{{ old('data[course_start_date]', $learner_response['course_start_date'] ?? '') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="assessment">
                        ...
                        <div class="row">
                            ...
                            {{--                                              rows="10" --}}
                            {{--                                              class="form-control ">{{ old('data[Q20. How many Data protection principles are there?]', $learner_response['Q20. How many Data protection principles are there?'] ?? '') }}</textarea> --}}
                            {{--                                </div> --}}
                            {{--                            </div> --}}
                            <div class="col-12">
                                <div class="form-group validList">
                                ...
                                <div class="col-12">
                                    <div class="form-group requiredRole">
                                        ...
                                        <textarea name="data[Q22. Classify the fire and give one example of each one]" id="q18_ans_evacuation" cols="30"
                                            rows="10" class="form-control ">{{ old('data[Q22. Classify the fire and give one example of each one]', $learner_response['Q22. Classify the fire and give one example of each one.'] ?? '') }}</textarea>
                                    </div>
                                </div>
                        ...
                        <div class="learnerDeclaration">
                            ...
                            <label class="d-flex align-items-center">
                                ...
                                <span style="color:#000;">I can confirm that I have spent the minimum of 9 hours, studying
                                    the SIA CCTV Operator course Distance Learning Booklet.</span>
                            </label>
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group requiredRole">
