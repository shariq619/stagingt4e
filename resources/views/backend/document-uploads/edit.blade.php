            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @php
                        $rejectedDocs = [];
                        $readableLabels = [
                            'first_front' => 'First Front Document',
                            'first_back' => 'First Back Document',
                            'second_front' => 'Second Front Document',
                            'second_back' => 'Second Back Document',
                            'third_front' => 'Third Front Document',
                            'third_back' => 'Third Back Document',
                        ];

                        if ($documentUpload->status === 'Rejected' && $documentUpload->comments) {
                            $rejectedDocs = is_string($documentUpload->rejected_documents)
                                ? json_decode($documentUpload->rejected_documents, true)
                                : ($documentUpload->rejected_documents ?? []);
                        }

                        $rejectedMessages = collect($rejectedDocs)->map(function($doc) use ($readableLabels) {
                            return $readableLabels[$doc] ?? ucfirst(str_replace('_', ' ', $doc));
                        });
                    @endphp
                    ...
                    @if($rejectedMessages->isNotEmpty())
                        <div class="alert alert-danger alert-dismissible mt-4" role="alert">
                            ...
                            <h5 class="mb-2"><strong>⚠ Document Rejection Notice</strong></h5>
                            <p><strong>Comments:</strong> {{ $documentUpload->comments }}</p>
                            <p>Please upload the following document(s) again:</p>
                            <ul class="mb-0 pl-3">
                                ...
                                <div class="form-group border p-4 border-width-2 border-dark">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="first_option" id="option1"
                                            value="passport"
                                            {{ old('first_option', $documentUpload->first_option) == 'passport' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="first_option" id="option2"
                                            value="dvlaLicence"
                                            {{ old('first_option', $documentUpload->first_option) == 'dvlaLicence' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="first_option" id="option4"
                                            ...
                                            {{ old('first_option', $documentUpload->first_option) == 'birthCertificate' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if ($documentUpload->first_front_upload)
                                            @php $nic_frontUrl = asset($documentUpload->first_front_upload); @endphp
                                        @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if ($documentUpload->first_back_upload)
                                            @php $first_back_uploadUrl = asset($documentUpload->first_back_upload); @endphp
                                        @endif
                                ...
                                <div class="form-group border p-4 border-width-2 border-dark">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @php
                                            $secondOption = old(
                                                'second_option',
                                                explode(',', $documentUpload->second_option ?? ''),
                                            );
                                        @endphp
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if ($documentUpload->second_front_upload)
                                                @php $second_front_uploadUrl = asset($documentUpload->second_front_upload); @endphp
                                            @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if ($documentUpload->second_back_upload)
                                                @php $second_back_uploadUrl = asset($documentUpload->second_back_upload); @endphp
                                            @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if ($documentUpload->third_front_upload)
                                                @php $third_front_uploadUrl = asset($documentUpload->third_front_upload); @endphp
                                            @endif
                                            <img id="third_front_upload_preview" class="imagePreview mt-2" width="150"
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if ($documentUpload->third_back_upload)
                                                @php $third_back_uploadUrl = asset($documentUpload->third_back_upload); @endphp
                                            @endif
                                            <img id="third_back_upload_preview" class="imagePreview mt-2" width="150"
