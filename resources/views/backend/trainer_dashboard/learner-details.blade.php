...
@section('breadcump')
    <div class="col-sm-6">
        <h1 class="m-0">{{ __('My Learners') }}</h1>
    </div>
    <div class="col-sm-6">
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-12 mb-4">
                <h2>Details for {{ $learner->name }} {{ $learner->last_name }}</h2>

                <div class="card">
                    <div class="card-body">


                        <!-- Door Supervisors Top-Up -->
                        @if($cohort->course->name == "Door Supervisors Top Up")
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>Course</th>
                                    <td>{{ $cohort->course->name ?? 'N/A' }}</td>
                                </tr>
                                <tr>
                                    <th>Start Date</th>
                                    <td>{{ \Carbon\Carbon::parse($cohort->start_date_time)->format('d F, Y, h:i A') }}</td>
                                </tr>
                                <tr>
                                    <th>End Date</th>
                                    <td>{{ \Carbon\Carbon::parse($cohort->end_date_time)->format('d F, Y, h:i A') }}</td>
                                </tr>
                                <tr>
                                    <th>Location</th>
                                    <td>{{ $cohort->venue->name ?? 'N/A' }}</td>
                                </tr>
                                <tr>
                                    <th>Course Status</th>
                                    <td>{{ $learner->pivot->course_status ?? 'Not Available' }}</td>
                                </tr>
                                <tr>
                                    <th>English Assessment</th>
                                    <td>
                                        <div class="mt-2">
                                            <a href="#" class="btn btn-danger text-white me-2">Review &
                                                Mark</a>
                                            <a href="#" class="btn btn-outline-secondary">Contact
                                                Learner</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="card p-4">
                                            <p class="mb-2"><strong>Title:</strong> ACT Awareness</p>
                                            <p class="mb-2"><strong>Attempts:</strong> 0</p>
                                            <p class="mb-2"><strong>Completion Status:</strong> UNKNOWN</p>
                                            <p class="mb-2"><strong>Success Status:</strong> UNKNOWN</p>
                                            <p class="mb-2"><strong>Score:</strong> 0</p>
                                            <p class="mb-2"><strong>Total Time Tracked:</strong> 0 hours, 0
                                                minutes,
                                                0 seconds</p>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <th>PI Techniques Questionnaire</th>
                                    <td>
                                        <div class="mt-2">
                                            <a href="#" class="btn btn-danger text-white me-2">Review &
                                                Mark</a>
                            ...
                            <!-- Door Supervisors -->
                        @elseif($cohort->course->name == "Door Supervisors")
                            <table class="table table-bordered">
                                <tbody>
                                <tr>
                                    <th>First Name</th>
                                ...
                                <tr>
                                    <th>Techniques Questionnaire</th>
                                    <td>
                                        <div class="mt-2">
                                            <a href="#" class="btn btn-danger text-white me-2">Review &
                                                Mark</a>
                        ...
                        @elseif($cohort->course->name == "Emergency First Aid at Work")
                            <table class="table table-bordered">
                                <tbody>
                                <tr>
                                    <th>First Name</th>
                ...
                <a href="{{ route('backend.trainer.my.learners') }}" class="btn btn-secondary mt-3">Back to List</a>
            </div>
        </div>
        @endsection
        ...
        @push('js')
            ...
            <script>
                ...
                !function (e, t) {
                    ...
                    "use strict";
                    var i, t, o, n, r, a, s, c, f, l, u, d, h, p, _, g, y, m, v, C, D, E, A, O, w, b, L, S, j, T, I, Q,
                        R, P, x,
                        B, M, k, H, N, Y, U, V, G, W, X, z, F, q, J, K, Z, $, ee, te,
