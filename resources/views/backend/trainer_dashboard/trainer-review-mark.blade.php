                ...
                <div class="otsTask mt-4 p-4 h-100">
                    <div class="otsTaskInner">
                        <div class="otstaskData">
                            ...
                            @php $task_file = Str::snake(strtolower($task->name)); @endphp
                            @include('backend.trainer_dashboard.trainerviews.'.$task_file,[
                                    'learner_response'=>$form_responses->response,
                                    'submission_id'=>$form_responses->id,
                                    'submission_pdf'=>$form_responses->pdf,
                            ])
