        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                @php
                    ...
                    $Q22 = $learner_response['data']['Q22. Classify the fire and give one example of each one'] ?? [];
                    ...
                    $learner_signature = $learner_response['signature'] ?? '';
                            ...
                            <div class="col-12">
                                <div class="form-group requiredRole">
                                    ...
                                    <textarea name="data[Q12. List different types of communication]"
                                              ...
                                              rows="10"
                                              class="form-control ">{{ $Q12 ?? '' }}</textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group validList">
                            ...
                            <div class="col-12">
                                <div class="form-group requiredRole">
                                    ...
                                    <textarea name="data[Q14. What are protected characteristics?]"
                                              ...
                                              rows="10"
                                              class="form-control ">{{ $Q14 ?? '' }}</textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group validList">
                            ...
                            <div class="col-12">
                                <div class="form-group requiredRole">
                                    ...
                                    <textarea
                                        ...
                                        id="q18_ans_evacuation" cols="30" rows="10"
                            ...
                            <div class="col-12">
                                <div class="form-group requiredRole">
                                    ...
                                    <textarea name="data[Q19. How many Data protection principles are there?]"
                                              ...
                                              rows="10"
                                              class="form-control ">{{ $Q19 ?? '' }}</textarea>
                                </div>
                            </div>
{{--                            <div class="col-12">--}}
{{--                                <div class="form-group requiredRole">--}}
...
{{--                            </div>--}}
                            <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="form-group requiredRole">
                                        ...
                                        <textarea name="data[Q22. Classify the fire and give one example of each one]"
                                                  id="q18_ans_evacuation" cols="30" rows="10"
                                ...
                                <div class="col-12">
                                    <div class="form-group requiredRole">
                                        ...
                                        <textarea name="data[Q22. What are internal fire doors used for?]"
                                                  id="q18_ans_evacuation" cols="30" rows="10"
                                                  class="form-control ">{{ $Q23 ?? "" }}</textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group requiredRole">
                                        <label>Q23. What is an emergency?<span>*</span></label>
                                        <textarea name="data[Q23. What is an emergency?]" id="q24_ans_emergency"
                                                  cols="30" rows="10"
                                ...
                                <div class="col-12">
                                    <div class="form-group requiredRole">
                                        ...
                                        <textarea
                                            name="data[Q25. What are the risks of lone working within the private security industry]"
                                            id="q26_ans_risks"
                                            cols="30" rows="10"
                                            class="form-control ">{{ $Q26 ?? '' }}</textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group validList">
                                ...
                                <div class="col-12">
                                    <div class="form-group requiredRole">
                                        ...
                                        <textarea cols="30" rows="10" class="form-control ">{{ $Q28 ?? '' }}</textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group validList">
                                ...
                                <div class="col-12">
                                    <div class="form-group requiredRole">
                                        ...
                                        <textarea name="data[Q31. What type of threat level is substational?]"
                                                  ...
                                                  rows="10"
                                                  class="form-control ">{{ $Q31 ?? '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <a href="{{ url($submission_pdf) }}" target="_blank" class="btn btn-success">View learner response in a
                    new window</a>
