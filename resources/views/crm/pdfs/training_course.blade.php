    ...
    <table class="main-table">
        ...
        <tbody>
            <tr>
                ...
                @if ($costing->discount > 0)
                    <td>£{{ number_format($costing->discount, 2) }}</td>
                @endif
                <td>£{{ number_format($costing->vat, 2) }}</td>
                {{-- <td>£{{ number_format($costing->total_price, 2) }}</td> --}}
            </tr>
            <tr>
                <td colspan="{{ $costing->discount > 0 ? 3 : 2 }}"></td>
                <td class="totals bold">Subtotal</td>
                <td>£{{ number_format($costing->cost_price, 2) }}</td>
            </tr>
            <tr>
                <td colspan="{{ $costing->discount > 0 ? 3 : 2 }}"></td>
                <td class="totals bold">Total VAT</td>
                <td>£{{ number_format($costing->vat, 2) }}</td>
            </tr>
            @if ($costing->discount > 0)
                <tr>
            ...
            <tr>
                ...
                <td class="bold">£{{ number_format($costing->total_price, 2) }}</td>
            </tr>
        </tbody>
    </table>
