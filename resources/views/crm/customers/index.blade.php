        ...
        <div class="page-inner py-3">
            <form id="filters" class="ribbon mb-3">
                <div class="group">
                    <input class="search" type="text" name="q" id="q"
                           placeholder="Search by company name, email or phone" style="width: 310px;">
                </div>
            ...
            <div class="card card-modern">
                ...
                <div class="card-body">
                    <div class="table-wrap">
                        <table class="table-modern" id="dtCustomers">
                            <thead>
                            <tr>
            ...
            <div id="finder" class="finder hidden">
                <div class="finder-head">
                    <div class="finder-title">Customer Directory</div>
...
@push('js')
    ...
    <script>
        ...
        function fetchFinder() {
            $.get("{{ route('crm.customers.quick') }}", params())
                .done(res => renderFinder(res.items || []))
                .fail(() => renderFinder([]))
        }
                ...
                columns: [
                    {data: 'id', name: 'id', width: '80px'},
                    {
                        ...
                        render: function (data, type, row) {
                            return `<a href="/crm/customers/${row.id}/detail" class="text-decoration-underline">${data}</a>`;
                        }
                    },
